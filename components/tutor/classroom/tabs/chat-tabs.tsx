...
import { ChatPanel } from '@/components/tutor/classroom/chat-panel';
          ...
          if (membersResponse.ok) {
            ...
            if (memberIds.length > 0) {
              await createNotification.mutateAsync({
                ...
                title: t('new_message_in_classroom', { name: classroom?.name || t('classroom') }),
...
function AnnouncementsTab() {
  ...
  const announcements = [
    ...
    },
    {
      ...
      content: t('dont_forget_homework'),
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <div className="text-xs text-muted-foreground">
              {t('automatically_scroll_new_messages')}
            </div>
          </div>
          <button
