              ...
              <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-900 dark:text-gray-100 font-medium">
                      {user.data.display_name || user.data.full_name || t('not_provided')}
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <Badge variant={getRoleBadgeVariant(user.data.role)} className="mt-1">
                      {user.data.role}
                    </Badge>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="flex flex-col gap-2 mt-1">
                      <Badge variant={getStatusBadgeVariant(user.data.status)}>
                        {user.data.status}
                      </Badge>
                      {user.data.status === 'banned' && user.data.banned_reason && (
                        <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-700 rounded-lg p-3">
                          <div className="flex items-start gap-2">
                            ...
                            <div className="text-sm">
                              ...
                              <p className="text-red-600 dark:text-red-300">{user.data.banned_reason}</p>
                              {user.data.banned_at && (
                                <p className="text-xs text-red-500 dark:text-red-400 mt-1">
                                  {t('banned_at')}: {formatRelativeTime(user.data.banned_at)}
                                </p>
                              )}
                            </div>
                          </div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <Badge variant={user.data.onboarded ? 'default' : 'secondary'} className="mt-1">
                      {user.data.onboarded ? t('completed') : t('pending')}
                    </Badge>
                  </div>
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      <div className="flex-1 bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                        <div 
                          ...
                          style={{ width: `${user.data.profile_completion}%` }}
                        />
                      </div>
                      <span className="text-sm font-medium text-gray-600 dark:text-gray-400">
                        {user.data.profile_completion}%
                      </span>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-900 dark:text-gray-100">
                      {user.data.created_at ? formatRelativeTime(user.data.created_at) : t('not_provided')}
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-900 dark:text-gray-100">
                      {user.data.last_login 
                        ? formatRelativeTime(user.data.last_login)
                        : t('never_logged_in')
                      }
                    </p>
                  </div>
              ...
              <CardContent>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700 rounded-lg p-4 text-center">
                    ...
                    <p className="text-2xl font-bold text-blue-600 dark:text-blue-400">
                      {user.data.course_enrollment?.[0]?.count || 0}
                    </p>
                  ...
                  <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-700 rounded-lg p-4 text-center">
                    ...
                    <p className="text-2xl font-bold text-green-600 dark:text-green-400">
                      {user.data.classroom_member?.[0]?.count || 0}
                    </p>
                  ...
                  <div className="bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-700 rounded-lg p-4 text-center">
                    ...
                    <p className="text-2xl font-bold text-purple-600 dark:text-purple-400">
                      {user.data.community_post?.[0]?.count || 0}
                    </p>
                  ...
                  <div className="bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-700 rounded-lg p-4 text-center">
                    ...
                    <p className="text-2xl font-bold text-orange-600 dark:text-orange-400">
                      {user.data.community_comment?.[0]?.count || 0}
                    </p>
