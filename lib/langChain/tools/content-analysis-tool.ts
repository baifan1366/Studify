...
export const contentAnalysisTool = new DynamicTool({
  ...
  description: `Analyze course content to extract topics, generate summaries, create quiz questions, or generate learning paths. 
  Input should be a JSON string with either 'content' or 'input' field: {"content": "content text", "analysisType": "summary|topics|questions|learning_path", "customPrompt"?: "optional custom prompt"} OR {"input": "content text", "analysisType": "learning_path", "customPrompt": "custom prompt"}`,
