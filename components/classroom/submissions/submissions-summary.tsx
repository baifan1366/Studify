...
export function SubmissionsSummary({
  ...
  const { data: membersData, isLoading: isMembersLoading, error: membersError } = useClassroomMembers(classroomSlug);
        ...
        <Card className="border-red-200 bg-red-50">
          <CardContent className="p-6">
            <div className="text-center">
              <p className="text-red-600 font-medium">Missing Classroom Information</p>
              <p className="text-red-500 text-sm mt-1">
                Unable to load submission statistics - classroom slug not provided
              </p>
            </div>
          </CardContent>
        </Card>
      ...
      {canGrade && (
        <div className="flex items-center justify-between p-4 bg-blue-50 dark:bg-blue-950 rounded-lg border border-blue-200 dark:border-blue-800">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="font-medium text-blue-900 dark:text-blue-100">Grading Dashboard</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        >
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {isSubmissionsLoading ? 'Loading...' : `${submissionRate.toFixed(1)}% submission rate`}
            </p>
          </CardContent>
        </Card>
        ...
        >
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {isGradesLoading ? 'Loading...' : `${gradingRate.toFixed(1)}% grading progress`}
            </p>
          </CardContent>
        </Card>
        ...
        >
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {isGradesLoading ? 'Loading...' : (averageGrade ? `${averageGrade.toFixed(1)}%` : 'N/A')}
            </div>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <Button 
                ...
                onClick={() => {
                  ...
                  const ungradedSubmissions = submissionsData?.submissions?.filter(
                    sub => !grades.some(grade => grade.user_id === sub.student_id)
                  ) || [];
            ...
            <div className="pt-4 border-t border-blue-200">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                <div>
                  <div className="text-lg font-semibold text-green-600">{gradedCount}</div>
                  <div className="text-xs text-muted-foreground">Completed</div>
                </div>
                <div>
                  <div className="text-lg font-semibold text-yellow-600">{submittedCount - gradedCount}</div>
                ...
                <div>
                  <div className="text-lg font-semibold text-gray-600">{totalStudents - submittedCount}</div>
