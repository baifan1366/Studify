...
3. THE Search Tool description SHALL 明确说明：用于课程内容、视频片段和内部知识查询
4. THE Web Search Tool description SHALL 明确说明：用于最新信息、新闻、趋势或外部知识查询，不适用于课程内部内容
5. THE System Prompt SHALL 指导 Agent：优先使用 Search Tool，仅在内部结果不足或问题涉及最新信息时使用 Web Search Tool
