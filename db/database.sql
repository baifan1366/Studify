...
CREATE TABLE public.chat_attachments (
    ...
    public_id uuid DEFAULT uuid_generate_v4() NOT NULL,
    uploader_id bigint NOT NULL REFERENCES public.profiles(id) ON DELETE CASCADE,
...
CREATE TABLE public.direct_messages (
    ...
    attachment_id bigint REFERENCES public.chat_attachments(id) ON DELETE SET NULL,
    reply_to_id bigint,
