  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-gray-600 dark:text-white/70">{t('loading_recommendations')}</div>
      </div>
    );
  }
    ...
    <div className="space-y-8">
      ...
      >
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">{t('personalized_title')}</h2>
          <span className="text-sm text-gray-600 dark:text-white/60 bg-gray-100 dark:bg-white/10 px-2 py-1 rounded-full">
            {t('powered_by_ai')}
          </span>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {recsLoading ? (
            ...
            <div className="col-span-full text-center py-12">
              <p className="text-gray-600 dark:text-white/70">{t('no_recommendations') || 'No recommendations available'}</p>
            </div>
          ) : (
      ...
      >
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">{t('learning_paths_title')}</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            >
              ...
              <p className="text-gray-600 dark:text-white/70 text-sm mb-4">{path.description}</p>
      ...
      >
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">{t('live_activity_title')}</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white dark:bg-white/10 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-white/20 p-4">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="font-semibold text-gray-900 dark:text-white">{t('currently_studying_title')}</h3>
            </div>
            <div className="text-3xl font-bold text-green-600 dark:text-green-400 mb-2">
              {realtimeStats.currentlyStudying.toLocaleString()}
            </div>
            <p className="text-gray-600 dark:text-white/60 text-sm">{t('students_online_now')}</p>
          </div>
          ...
          <div className="bg-white dark:bg-white/10 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-white/20 p-4">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="font-semibold text-gray-900 dark:text-white">{t('new_this_week_title')}</h3>
            </div>
            <div className="text-3xl font-bold text-blue-600 dark:text-blue-400 mb-2">
              {realtimeStats.newCoursesThisWeek}
            </div>
            <p className="text-gray-600 dark:text-white/60 text-sm">{t('fresh_courses_added')}</p>
          </div>
          ...
          <div className="bg-white dark:bg-white/10 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-white/20 p-4">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="font-semibold text-gray-900 dark:text-white">{t('from_your_teacher_title')}</h3>
            </div>
            <div className="text-3xl font-bold text-purple-600 dark:text-purple-400 mb-2">
              {realtimeStats.teacherRecommendations}
            </div>
            <p className="text-gray-600 dark:text-white/60 text-sm">{t('recommendations_waiting')}</p>
          </div>
        </div>
      </motion.section>
      ...
      >
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">{t('community_progress_title')}</h2>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Study Groups */}
          <div className="bg-gray-50 dark:bg-white/10 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-white/20 p-4">
            ...
            <div className="space-y-3">
              {['SAT Math Prep Group', 'Physics Problem Solvers', 'AI Enthusiasts'].map((group, index) => (
                <div key={index} className="flex items-center justify-between">
                  <span className="text-gray-700 dark:text-white/80">{group}</span>
              ...
              {[
                ...
                <div key={index} className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className={`${user.name === 'You' ? 'text-blue-600 dark:text-blue-400 font-semibold' : 'text-gray-700 dark:text-white/80'}`}>
                      {user.name}
                    </span>
                  </div>
                  <span className="text-gray-600 dark:text-white/60">{user.points} {t('points_suffix')}</span>
                </div>
              ))}
            </div>
          </div>
